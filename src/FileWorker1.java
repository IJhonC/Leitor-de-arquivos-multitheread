...
public class FileWorker1 extends SwingWorker<String, String> {
    ...
    public FileWorker1(String filePath, JTextArea textArea, int tempo, JButton button, JTextField textField) {
    ...
    private int contaTotalLinhas(String filePath) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
            ...
            mostraErro("Erro ao contar as linhas do arquivo 1: " + e.getMessage());
        }
        return lineCount;
    }
